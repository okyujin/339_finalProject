...
const certificateHideBtn = document.querySelector(".cancel-btn");
let question = document.querySelector(".question-section")

const certificate = document.querySelector(".complete");
...
function generateCertificate() {
  ...
  const scoreSec = document.querySelector(".certificate-score");
  const nameSec = document.querySelector(".certificate-name");
  const idSec = document.querySelector(".certificate-id");
  ...
  certificateHideBtn.addEventListener('click', () => {
    hideCertificate();
    restartQuiz();
  })
...
function hideCertificate() {
  certificate.classList.add("complete-hide");
...
nextBtn.addEventListener('click', () => {
  ...
  if (i === questions.length - 1) {
    certificate.classList.remove("complete-hide");
    generateCertificate();
